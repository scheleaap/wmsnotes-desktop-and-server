...
internal abstract class ModifiableEventRepositoryTest {
    ...
    protected val events = listOf(
            NoteCreatedEvent(eventId = 1, noteId = "note-1", revision = 1, path = Path("p1"), title = "Title 1", content = "Text 1") to "DATA1",
            NoteCreatedEvent(eventId = 2, noteId = "note-2", revision = 2, path = Path("p2"), title = "Title 2", content = "Text 2") to "DATA2",
            NoteCreatedEvent(eventId = 3, noteId = "note-3", revision = 3, path = Path("p3"), title = "Title 3", content = "Text 3") to "DATA3"
    )
