...
internal class KryoEventSerializerTest : KryoSerializerTest<Event>() {
    ...
    override val items: List<Event> = listOf(
            NoteCreatedEvent(eventId = 1, noteId = noteId, revision = 1, path = Path("path"), title = "Title", content = "Text"),
            ...
            MovedEvent(eventId = 0, noteId = noteId, revision = 1, path = Path("path"))
